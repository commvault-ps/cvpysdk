...
class Instances:
    ...
    def __init__(self, agent_object):
        ...
        self._INSTANCES = self._services["GET_ALL_INSTANCES"] % (self._client_object.client_id)
    ...
    def __str__(self):
        ...
        for index, instance in enumerate(self._instances):
            sub_str = f"{index + 1:^5}\t{instance:20}\t{self._agent_object.agent_name:20}\t{self._client_object.client_name:20}\n"
    ...
    def __repr__(self):
        ...
        return f"Instances class instance for Agent: '{self._agent_object.agent_name}'"
    ...
    def __getitem__(self, value):
        ...
        if value in self.all_instances:
            ...
            try:
                return list(filter(lambda x: x[1] == value, self.all_instances.items()))[0][0]
            except IndexError:
    ...
    def _get_instances(self):
        ...
        if "file system" in self._agent_object.agent_name:
            return_dict = {"defaultinstancename": 1}
            return return_dict
            ...
            if response.json():
                if "instanceProperties" in response.json():
                    ...
                    for dictionary in instance_properties:
                        ...
                        if (self._agent_object.agent_name in agent) or (
                            "mariadb" in agent and "mysql" in self._agent_object.agent_name
                        ):
                        ...
                        if "vsInstanceType" in dictionary.get("virtualServerInstance", ""):
                            self._vs_instance_type_dict[
                                str(dictionary["instance"]["instanceId"])
                            ] = dictionary["virtualServerInstance"]["vsInstanceType"]
    ...
    def get(self, instance_name):
        ...
        if isinstance(instance_name, str):
            ...
            raise SDKException(
                "Instance", "102", f'No instance exists with name: "{instance_name}"'
            )
            ...
            raise SDKException(
                "Instance", "102", f"No Instance exists with the given ID: {instance_name}"
            )
            ...
            if response.json():
                if "response" in response.json():
                    ...
                    if error_code != 0:
                        ...
                        o_str = f'Failed to create instance\nError: "{error_string}"'
    ...
    def add_informix_instance(self, informix_options):
        ...
        if self.has_instance(informix_options["instance_name"]):
            raise SDKException(
                "Instance",
                "102",
                'Instance "{0}" already exists.'.format(informix_options["instance_name"]),
            )
        ...
        if informix_options.get("credential_name"):
            creds = {
                "savedCredential": {"credentialName": informix_options.get("credential_name")}
            }
        elif informix_options.get("user_name"):
            creds = {"userName": informix_options["user_name"]}
        else:
            raise SDKException(
                "Instance",
                "102",
            ...
            if response.json() and "response" in response.json():
                ...
                if error_code != 0:
                    ...
                    raise SDKException(
                        "Instance",
                        "102",
                        f'Error while creating instance\nError: "{error_string}"',
                    )
                else:
    ...
    def add_sap_hana_instance(self, **kwargs):
        ...
        if self.has_instance(kwargs.get("sid", "")):
            raise SDKException(
                "Instance", "102", 'Instance "{0}" already exists.'.format(kwargs.get("sid", ""))
            )
        ...
        request_json = {
            "instanceProperties": {
                ...
                "saphanaInstance": {
                    ...
                    "SAPHANAUser": {"userName": f"{kwargs.get('sid', '').lower()}adm"},
                    "dbUser": {"userName": kwargs.get("db_user_name", ""), "password": password},
                    ...
                    "DBInstances": [{"clientName": kwargs.get("hana_client_name", "")}],
                },
            }
        }
    ...
    def delete(self, instance_name):
        ...
        if self.has_instance(instance_name):
                    ...
                    if "response" in response.json():
                        ...
                        if error_message:
                            ...
                            if error_code == "0":
                                ...
                                o_str = (
                                    'Failed to delete instance with Error Code: "{0}"\n'
            ...
            raise SDKException("Instance", "102", f"No Instance exists with name: {instance_name}")
    ...
    def add_sybase_instance(self, sybase_options):
        ...
        if self.has_instance(sybase_options["instance_name"]):
            raise SDKException(
                "Instance",
                "102",
                'Instance "{0}" already exists.'.format(sybase_options["instance_name"]),
            )
        ...
        if self._commcell_object.credentials.has_credential(sybase_options["credential_name"]):
            ...
            credential = self._commcell_object.credentials.add_sybase_database_creds(
                sybase_options["credential_name"],
        ...
        request_json = {
            "instanceProperties": {
                ...
                "planEntity": {"planName": sybase_options["storage_policy"]},
                "sybaseInstance": {
                    ...
                    "localAdministrator": {"savedCredential": {}},
                },
            }
        }
        if "masterkey_credential_name" in sybase_options.keys():
            credential = self._commcell_object.credentials.get(
                sybase_options["masterkey_credential_name"]
            )
            request_json["instanceProperties"]["credentialEntity"] = {}
            request_json["instanceProperties"]["credentialEntity"]["credentialId"] = (
                credential.credential_id
            )
            request_json["instanceProperties"]["credentialEntity"]["credentialName"] = (
                credential.credential_name
            )

        if "oscreds" in sybase_options.keys():
            credential = self._commcell_object.credentials.get(sybase_options["oscreds"])
            request_json["instanceProperties"]["sybaseInstance"]["localAdministrator"][
                "savedCredential"
            ]["credentialId"] = credential.credential_id
            request_json["instanceProperties"]["sybaseInstance"]["localAdministrator"][
                "savedCredential"
    ...
    def add_db2_instance(self, db2_options):
        ...
        if not all(
            ...
            raise SDKException("Instance", "102", "Not all db2_options are provided")

        if not db2_options.get("instance_name"):
            raise SDKException("Instance", "102", 'Instance "{0}" already exists.')
        ...
        if self._commcell_object.credentials.has_credential(db2_options["credential_name"]):
            ...
            credential = self._commcell_object.credentials.add_db2_database_creds(
                db2_options["credential_name"], db2_options["user_name"], db2_options["password"]
            )
        ...
        request_json = {
            "instanceProperties": {
                ...
                "db2Instance": {
                    ...
                    "DB2StorageDevice": {
                        "dataBackupStoragePolicy": {"storagePolicyId": 1},
                        "commandLineStoragePolicy": {"storagePolicyId": 1},
                        "logBackupStoragePolicy": {"storagePolicyId": 1},
                    },
                },
            }
        }
    ...
    def add_big_data_apps_instance(self, distributed_options):
        ...
        if self.has_instance(distributed_options["instanceName"]):
            raise SDKException(
                "Instance",
                "102",
                'Instance "{0}" already exists.'.format(distributed_options["instanceName"]),
            )
        ...
        cluster_config = {}
        uxfs_config = (
            cluster_properties.get("distributedClusterInstance", {})
            .get("clusterConfig", {})
            .get("uxfsConfig")
        )
        hadoop_config = (
        ...
        if uxfs_config is not None:
            uxfs_config["coordinatorNode"] = {
                "clientName": distributed_options.get("MasterNode", "")
            }
            cluster_config["uxfsConfig"] = uxfs_config
        if hadoop_config is not None:
            hadoop_config["coordinatorNode"] = {
                "clientName": distributed_options.get("MasterNode", "")
            }
            hbase_config = (
                hadoop_config.get("hadoopApps", {}).get("appConfigs", [{}])[0].get("hBaseConfig")
            )
        ...
        request_json = {
            "instanceProperties": {
                ...
                "distributedClusterInstance": {
                    ...
                    "instance": {"instanceName": distributed_options["instanceName"]},
                    "clusterConfig": cluster_config,
                    "dataAccessNodes": {"dataAccessNodes": distributed_options["dataAccessNodes"]},
                },
            }
        }
    ...
    def add_cloud_storage_instance(self, cloud_options):
        ...
        if cloud_options.get("instance_name"):
            if self.has_instance(cloud_options.get("instance_name")):
                raise SDKException(
                    "Instance",
                    "102",
                    'Instance "{0}" already exists.'.format(cloud_options.get("instance_name")),
                )
        else:
            raise SDKException("Instance", "102", "Empty instance name provided")
        ...
        if cloud_options.get("storage_plan"):
            ...
            raise SDKException("Instance", "102", "Empty storage plan provided")
    ...
    def add_salesforce_instance(
        self, instance_name, access_node, salesforce_options, db_options=None, **kwargs
    ):
        ...
        salesforce_consumer_secret = b64encode(
            salesforce_options.get("consumer_secret", "3951207263309722430").encode()
        ).decode()
            ...
            "instanceProperties": {
                ...
                "cloudAppsInstance": {
                    ...
                    "salesforceInstance": {
                        ...
                        "consumerId": salesforce_options.get(
                            "consumer_id",
                    ...
                    "generalCloudProperties": {
                        ...
                        "proxyServers": [{"clientName": access_node}],
                        "storageDevice": {
                            "dataBackupStoragePolicy": {
                                "storagePolicyName": kwargs.get("storage_policy", "")
                            },
        ...
        request_json = {
            "instanceProperties": {
                ...
                "postGreSQLInstance": {
                    ...
                    "SAUser": {},
                    "logStoragePolicy": {"storagePolicyName": kwargs.get("storage_policy", "")},
                    "credentialEntity": {"credentialName": kwargs.get("credential_name", "")},
                },
            }
        }
        self._process_add_response(request_json)
    ...
    def _general_properties_json(self, value):
        ...
        if value.get("cloudapps_type") in supported_cloudapps_type:
            self._general_properties = {
                "accessNodes": {
                    "memberServers": [{"client": {"clientName": value.get("access_node")}}]
                },
                "amazonInstanceInfo": {
            ...
            self._general_properties = {
                ...
                "proxyServers": [{"clientName": value.get("access_node")}],
                "storageDevice": {
                    "dataBackupStoragePolicy": {"storagePolicyName": value.get("storage_policy")}
                },
            }
        ...
        if value.get("cloudapps_type") == "s3":
            ...
            self._instance_properties = {
                ...
                "oraCloudInstance": {
                    ...
                    "user": {"password": password, "userName": value.get("username")},
                },
                "generalCloudProperties": self._general_properties_json,
            }
            ...
            self._instance_properties = {
                ...
                "openStackInstance": {
                    ...
                    "credentials": {"password": apikey, "userName": value.get("username")},
                },
                "generalCloudProperties": self._general_properties_json,
            }
            ...
            self._instance_properties = {
                ...
                "googleCloudInstance": {
                    ...
                    "credentials": {"password": secret_key, "userName": value.get("access_key")},
                },
                "generalCloudProperties": self._general_properties_json,
            }
            ...
            self._instance_properties = {
                ...
                "azureDataLakeInstance": {
                    ...
                    "credentials": {"userName": value.get("accountname"), "password": accesskey},
                },
                "generalCloudProperties": self._general_properties_json,
            }
    ...
    def add_mysql_instance(self, instance_name, database_options):
        ...
        if not self._commcell_object.credentials.has_credential(
    ...
    def add_oracle_instance(self, instance_name, **oracle_options):
        ...
        for option in required_options:
            if option not in oracle_options.keys():
                raise SDKException(
                    "Instance",
                    "102",
                    f"Required option: {option} is missing, Please provide all parameters:",
                )
        ...
        if username == "/":
            request_json["instanceProperties"]["oracleInstance"]["sqlConnect"] = {"userName": "/"}
            request_json["instanceProperties"]["oracleInstance"]["dbConnectCredInfo"] = {
                "credentialName": ""
            }
        else:
            if not self._commcell_object.credentials.has_credential(
                oracle_options.get("credential_name")
            ):
                self._commcell_object.credentials.add_oracle_database_creds(
                    oracle_options.get("credential_name"),
                    username,
                    connect_string_password,
                    service_name,
                )
            request_json["instanceProperties"]["oracleInstance"]["dbConnectCredInfo"] = {
        ...
        if oracle_options.get("catalog_connect") and oracle_options.get("catalog_credential"):
            ...
            if not self._commcell_object.credentials.has_credential(
                oracle_options.get("catalog_credential")
            ):
        ...
        if "win" in self._agent_object._client_object.os_info.lower():
            if oracle_options.get("oracle_domain_name") and oracle_options.get("oracle_user_name"):
                os_username = (
                    f"{oracle_options['oracle_domain_name']}\\{oracle_options['oracle_user_name']}"
                )
                if not self._commcell_object.credentials.has_credential(
                    oracle_options.get("osuser_credential")
                ):
                    self._commcell_object.credentials.add(
                        "windows", oracle_options.get("osuser_credential"), os_username, password
                    )
    ...
    def add_cosmosdb_instance(self, instance_name, **instance_options):
        ...
        request_json = {
            "instanceProperties": {
                ...
                "planEntity": {"planName": instance_options.get("plan_name")},
            }
        }
...
class Instance:
    ...
    def _get_instance_properties(self):
        ...
        instance_service = f"{self._INSTANCE}?association/entity/clientId={self._agent_object._client_object.client_id}&association/entity/applicationId={self._agent_object.agent_id}"
        ...
        if flag:
            if response.json() and "instanceProperties" in response.json():
                ...
                try:
                    ...
                    instance_service = (
                        f"{self._ALLINSTANCES}&applicationId={self._agent_object.agent_id}"
                    )
                    flag, response = self._cvpysdk_object.make_request("GET", instance_service)
                    if flag:
                        if response.json() and "instanceProperties" in response.json():
                            self._properties = response.json()["instanceProperties"][0]
                            self._instance = self._properties["instance"]
                            self._instance_name = self._properties["instance"][
                                "instanceName"
                            ].lower()
                            self._instanceActivityControl = self._properties[
    ...
    def _process_search_response(self, request_json):
        ...
        """
        flag, response = self._cvpysdk_object.make_request(
            "POST", self._SEARCH_DURING_RESTORE, request_json
        )
        self._restore_association = None
        result = []
        if flag:
    ...
    def _restore_json(self, **kwargs):
        ...
        if "versions" in restore_option:
            ...
            if not isinstance(versions, list):
                raise SDKException("Instance", "101")
            if (
                "win" in self._agent_object._client_object.os_info.lower()
                or self._agent_object._agent_name == "virtual server"
            ):
        ...
        if restore_option.get("index_free_restore", False):
            ...
            request_json["taskInfo"]["subTasks"][0]["options"]["restoreOptions"]["jobIds"] = (
                jobs_list
            )
            source_item = []
            for i in jobs_list:
                source_item.append(f"2:{i}")
        ...
        if restore_option.get("schedule_pattern") is not None:
            request_json = SchedulePattern().create_schedule(
                request_json, restore_option["schedule_pattern"]
            )
        ...
        if restore_option.get("multinode_restore", False):
            ...
            request_json["taskInfo"]["subTasks"][0]["options"]["restoreOptions"]["qrOption"] = (
                self._qr_restore_option
            )
        ...
        if restore_option.get("useAutoStreamCalculation", False):
            request_json["taskInfo"]["subTasks"][0]["options"]["restoreOptions"][
                "useAutoStreamCalculation"
            ] = True

        if "sync_restore" in restore_option:
            request_json["taskInfo"]["subTasks"][0]["options"]["restoreOptions"]["syncOption"] = (
        ...
        if "backup_level" in restore_option:
            backup_opt_json = {"backupLevel": restore_option.get("backup_level", "Incremental")}
        ...
        if "latest_version" in restore_option:
            request_json["taskInfo"]["subTasks"][0]["options"]["restoreOptions"]["commonOptions"][
                "restoreLatestVersionOnly"
            ] = restore_option.get("latest_version", True)
    ...
    def _process_update_request(self, request_json):
        ...
        if not status:
            raise SDKException(
                "Instance",
                "102",
                f'Failed to update the instance properties\nError: "{error_string}"',
            )
        self.refresh()
    ...
    def update_properties(self, properties_dict):
        ...
        **Note** self.properties can be used to get a deep copy of all the properties, modify the properties which you
        ...
        """
        request_json = {"instanceProperties": {}}
    ...
    def _restore_sub_task(self):
        ...
        sub_task = {"subTaskType": 3, "operationType": 1001}
    ...
    def _impersonation_savedcred_json(self, value):
        ...
        self._impersonation_json_ = {
            "useImpersonation": use_impersonate,
            "user": {"savedCredential": {"credentialName": value.get("credentialName", "")}},
        }
    ...
    def _restore_browse_option_json(self, value):
        ...
        self._browse_restore_json = {
            ...
            "mediaOption": {
                "mediaAgent": {"mediaAgentName": value.get("media_agent", None) or ""},
                "proxyForSnapClients": {
                    "clientName": value.get("snap_proxy", None)
                    or value.get("proxy_client", None)
                    or ""
                },
                "library": {},
                "copyPrecedence": {
    ...
    def _restore_common_opts_json(self, value):
        ...
        self._commonopts_restore_json = {"jobDescription": options.get("job_description", "")}
        ...
        if value.get("advanced_options"):
            if value["advanced_options"].get("iSeriesObject"):
                ...
                if ibmi_value.get("restorePrivateAuthority"):
                    ibmi_opts.update(
                        {"restorePrivateAuthority": ibmi_value.get("restorePrivateAuthority")}
                    )
                if ibmi_value.get("restoreSpooledFileData"):
                    ibmi_opts.update(
                        {"restoreSpooledFileData": ibmi_value.get("restoreSpooledFileData")}
                    )
                ...
                if ibmi_value.get("forceObjectConversionSelction"):
                    ibmi_opts.update(
                        {
                            "forceObjectConversionSelction": ibmi_value.get(
                ...
                if ibmi_value.get("securityDataParameter"):
                    ibmi_opts.update(
                        {"securityDataParameter": ibmi_value.get("securityDataParameter")}
                    )
    ...
    def _restore_destination_json(self, value):
        ...
        if (
            value.get("proxy_client") is not None
            and (self._agent_object.agent_name).upper() == "FILE SYSTEM"
        ):
            self._destination_restore_json = {
                "inPlace": value.get("in_place", True),
                "destClient": {"clientName": value.get("proxy_client", "")},
            }
        ...
        # For Index server restore, we need to set proxy client & in-place flag
            ...
            value.get("proxy_client") is not None
            and (self._agent_object.agent_name).upper() == "BIG DATA APPS"
            and self.name.upper() == "DYNAMICINDEXINSTANCE"
        ):
            self._destination_restore_json = {
                "inPlace": value.get("in_place", True),
                "destClient": {"clientName": value.get("proxy_client", "")},
    ...
    def _restore_fileoption_json(self, value):
        ...
        self._fileoption_restore_json = {
            "sourceItem": value["instant_clone_options"]["instant_clone_src_path"]
            if value.get("instant_clone_options", None)
            else value.get("paths", []),
        ...
        if value.get("instant_clone_options", None):
            ...
            if value["instant_clone_options"].get("clone_cleanup_script", None):
                self._fileoption_restore_json["fsCloneOptions"]["cloneCleanupOptions"] = {
                    "cleanupScriptPath": value.get("instant_clone_options").get(
    ...
    def _restore_bigdataapps_option_json(self, value):
        ...
        request_json["taskInfo"]["associations"][0]["subclientId"] = value.get("subclient_id", -1)
        request_json["taskInfo"]["associations"][0]["backupsetName"] = value.get("backupset_name")
        request_json["taskInfo"]["associations"][0]["_type_"] = value.get("_type_")
        ...
        if value.get("cockroachdb_restore", False):
            ...
            distributed_restore_json["noSQLGenericRestoreOptions"] = {
                ...
                "tableMap": [
                    {"fromTable": value.get("fromtable"), "toTable": value.get("totable")}
                ],
            }
    ...
    def _restore_virtual_rst_option_json(self, value):
        ...
        self._virtualserver_restore_json = {"isFileBrowse": value.get("fileBrowse")}
    ...
    def _restore_sharepoint_json(self):
        ...
        _sharepoint_restore_json = {"is90OrUpgradedClient": False}
    ...
    def _json_restore_subtask(self):
        ...
        _subtask_restore_json = {"subTaskType": 3, "operationType": 1001}
    ...
    def _json_restore_by_job_subtask(self):
        ...
        _subtask_restore_by_job_json = {"subTaskType": 3, "operationType": 1005}
    ...
    def credentials(self, credential_name):
        ...
        credential_json = {"credentialId": credential_id, "credentialName": credential_name}
