...
class TeamsConstants:
    ...
    ADD_USER_JSON = {"_type_": None, "userGUID": None}

    ADD_TEAM_JSON = {
        "displayName": None,
        "smtpAddress": None,
        "associated": False,
        "msTeamsInfo": {"visibility": 1, "teamsCreatedTime": None},
        "user": None,
    }

    ADD_GROUP_JSON = {"associated": False, "name": None, "id": None}
    ...
    ADD_REQUEST_JSON = {
        ...
        "cloudAppAssociation": {
            ...
            "cloudAppDiscoverinfo": {"discoverByType": ADD_DISCOVER_TYPE, "userAccounts": []},
            "plan": {"planId": None},
        },
    }
    ...
    BACKUP_TEAM_JSON = {
        ...
        "ParentWebGuid": "",
        "commonFlags": 0,
        "msTeamsInfo": {"visibility": 1},
        "lastBackupJobRanTime": {},
        "IdxCollectionTime": {},
        "user": None,
    }

    BACKUP_USER_JSON = {"user": None}
        ...
        "options": {
            ...
            "commonOpts": {
                ...
                "jobMetadata": [
                    {
                        "jobOptionItems": [
                            {"value": "Disabled", "option": "Convert job to full"},
                            {"value": "Disabled", "option": "Total running time"},
                        ],
                        "selectedItems": [],
                    }
                ],
    ...
    BACKUP_REQUEST_JSON = {
        ...
        "taskInfo": {"associations": [], "task": {"taskType": 1}, "subTasks": []},
    }

    RESTORE_TASK_JSON = {"initiatedFrom": 2, "taskType": 1, "policyType": 0}

    RESTORE_SUBTASK_JSON = {"subTaskType": 3, "operationType": 1001}

    CUSTOM_CATEGORY_JSON = {
        "subclientEntity": {"subclientId": None},
        "planEntity": {"planId": None, "planName": ""},
        "status": 0,
        "categoryName": None,
        "categoryQuery": {"conditions": []},
    ...
    ClOUD_APP_EDISCOVER_TYPE = {"Teams": 8, "Users": 7, "Groups": 22}

    DESTINATION_ONEDRIVE_INFO = {"userSMTP": None, "userGUID": None, "folder": "/"}
            ...
            "subTasks": [
                {
                    ...
                    "options": {
                        "commonOpts": {
                            "notifyUserOnJobCompletion": False,
                            "jobMetadata": [{"selectedItems": [], "jobOptionItems": []}],
                        },
                        "restoreOptions": {
                            "browseOption": {"commCellId": 2},
                            "destination": {
                                "inPlace": False,
                                "destClient": {},
                                "destPath": None,
                                ...
                                "msTeamsRestoreOptions": {
                                    ...
                                    "findQuery": {
                                        ...
                                        "searchProcessingInfo": {
                                            ...
                                            "sortParams": [
                                                {"sortDirection": 0, "sortField": "TEAMS_NAME"}
                                            ],
                                        },
                                    },
