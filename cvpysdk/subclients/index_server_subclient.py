...
class IndexServerSubclient(BigDataAppsSubclient):
    ...
    def __init__(self, backupset_object, subclient_name, subclient_id=None):
        ...
        self._index_server_obj = self._commcell_object.index_servers.get(
    ...
    def _get_path_for_restore(self, roles=None, core_name=None, client=None):
        ...
        if client not in self._index_server_obj.client_name:
            raise SDKException(
                "IndexServers", "104", "Given client name is not part of index server cloud"
            )
        ...
        if core_name is None and roles is not None:
            ...
            for core in core_name:
                paths.append(
                    f"{path_delimiter}{roles[0]}{path_delimiter}{client}{path_delimiter}{core}"
                )
    ...
    def do_restore_in_place(
        self, roles=None, core_name=None, overwrite=True, from_time=None, to_time=None, client=None
    ):
    ...
    def do_restore_out_of_place(
        ...
        paths = self._get_path_for_restore(roles=roles, core_name=core_name, client=client)
        job_obj = self.restore_out_of_place(
            client=dest_client,
    ...
    def get_file_details_from_backup(
        self, roles=None, include_files=True, job_id=0, index_server_node=None, **kwargs
    ):
