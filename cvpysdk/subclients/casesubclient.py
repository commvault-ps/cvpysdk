...
class CaseSubclient(Subclient):
    ...
    def json_hold_info(self):
        ...
        hold_type_dict = {"user mailbox": 1, "journal mailbox": 2, "contentstore mailbox": 3}
        self._hold_info_ = [
            {
    ...
    def json_search_request(self):
        ...
        self._search_request_ = {
            "advSearchGrp": {"emailFilter": self._filter_list},
            "searchProcessingInfo": {"queryParams": [{"param": "LANGUAGE", "value": "ENGLISH"}]},
        }
    ...
    def json_index_copy_options(self):
        ...
        self._index_copy_option_json_ = {
            "adminOpts": {"caseMgrOptions": {"type": 1}},
        }
    ...
    def json_data_copy_subtasks(self):
        ...
        self._subtask_data_copy_json_ = {"subTaskType": 2, "operationType": 2}
    ...
    def json_data_copy_options(self):
        ...
        self._data_copy_option_json_ = {
            "backupOpts": {"caseMgrOptions": {"type": 2}},
        }
    ...
    def json_index_copy_subtasks(self):
        ...
        self._subtask_index_copy_json_ = {"subTaskType": 1, "operationType": 5023}
    ...
    def json_content_indexing_subtasks(self):
        ...
        self._subtask_content_indexing_json_ = {"subTaskType": 1, "operationType": 5020}
    ...
    def _prepare_email_filter_list(self, options):
        ...
        for item in options.get("filters"):
            filter_json = {
                ...
                "fieldValues": {"values": item.get("values", [])},
            }
                ...
                "subTasks": [
                    {
                        ...
                        "options": {"backupOpts": {"mediaOpt": self.json_media_options}},
                    }
                ],
            }
        }
