...
class FileSystemSubclient(Subclient):
    ...
    def _get_subclient_properties(self):
        ...
        self._global_filter_status_dict = {"OFF": 0, "ON": 1, "USE CELL LEVEL POLICY": 2}
    ...
    def _get_subclient_properties_json(self):
        ...
        subclient_json = {
            "subClientProperties": {
                ...
                if not hasattr(self, "_fsExcludeFilterOperationType")
                else self._fsExcludeFilterOperationType,
                "fsIncludeFilterOperationType": "OVERWRITE"
                if not hasattr(self, "_fsIncludeFilterOperationType")
                else self._fsIncludeFilterOperationType,
            }
        }
    ...
    def _set_content(self, content=None, filter_content=None, exception_content=None):
    ...
    def _common_backup_options(self, options):
        ...
        """
        final_dict = super()._common_backup_options(options)
    ...
    def _advanced_backup_options(self, options):
        ...
        if "start_new_media" in options and options["start_new_media"]:
            media_opts = {"startNewMedia": options.get("start_new_media", False)}
        ...
        if options.get("media_agent_name"):
            ...
            final_dict["dataPathOpt"] = {"mediaAgent": {"mediaAgentName": media_agent_name}}
    ...
    def filter_content(self, value):
        ...
        if isinstance(value, list):
            ...
            raise SDKException(
                "Subclient", "102", "Subclient filter content should be a list value"
            )
    ...
    def trueup_option(self, trueup_option_value):
        ...
        self._set_subclient_properties(
            "_fsSubClientProp['isTrueUpOptionEnabledForFS']", trueup_option_value
        )
    ...
    def backup_retention(self, value):
        ...
        if isinstance(value, bool):
            if value:
                new_value = {"extendStoragePolicyRetention": True, "backupRetention": True}
            else:
                new_value = {"backupRetention": False}
            self._set_subclient_properties("_fs_subclient_prop", new_value)
        else:
            raise SDKException("Subclient", "102", "argument should only be boolean")
    ...
    def block_level_backup_option(self, block_level_backup_value):
        ...
        self._set_subclient_properties(
            "_fsSubClientProp['blockLevelBackup']", block_level_backup_value
        )
    ...
    def create_file_level_index_option(self, create_file_level_index_value):
        ...
        self._set_subclient_properties(
            "_fsSubClientProp['createFileLevelIndexDuringBackup']", create_file_level_index_value
        )
    ...
    def backup_retention_days(self, value):
        ...
        if isinstance(value, int):
            if "afterDeletionKeepItemsForNDays" in self._fsSubClientProp:
                if value != -1:
                    new_value = {"afterDeletionKeepItemsForNDays": value, "backupRetentionMode": 1}
                else:
                    new_value = {"afterDeletionKeepItemsForNDays": value}
            else:
                new_value = {"daysToKeepItems": value}
    ...
    def system_state_option(self, backup_system_state):
        ...
        """
        self._set_subclient_properties(
            "_fsSubClientProp['backupSystemState']", backup_system_state
        )
    ...
    def onetouch_server(self, onetouch_server):
        ...
        """
        self._set_subclient_properties(
            "_fsSubClientProp['oneTouchServer']['clientName']", onetouch_server
        )
    ...
    def onetouch_server_directory(self, onetouch_server_directory):
        ...
        """
        self._set_subclient_properties(
            "_fsSubClientProp['oneTouchServerDirectory']", onetouch_server_directory
        )
    ...
    def trueup_days(self, trueup_days_value):
        ...
        if isinstance(trueup_days_value, int):
            self._set_subclient_properties(
                "_fsSubClientProp['runTrueUpJobAfterDaysForFS']", trueup_days_value
            )
        else:
    ...
    def archiver_retention(self, value):
        ...
        if isinstance(value, bool):
            if value:
                new_value = {"extendStoragePolicyRetention": True, "archiverRetention": True}
            else:
    ...
    def archiver_retention_days(self, value):
        ...
        if isinstance(value, int):
            if value != -1:
                new_value = {"extendRetentionForNDays": value, "archiverRetentionMode": 1}
            else:
                new_value = {"extendRetentionForNDays": value}
            self._set_subclient_properties("_fs_subclient_prop", new_value)

        else:
            raise SDKException("Subclient", "102", "argument should only be integer")
    ...
    def backup_only_archiving_candidate(self, value):
        ...
        if isinstance(value, bool):
            ...
            raise SDKException("Subclient", "102", "The parameter must be boolean type")
        ...
        if isinstance(value, dict):
            ...
            if "olderFileVersionsMode" in self._fsSubClientProp:
                if value["Mode"] == 1 or value["Mode"] == 2:
                    ...
                    raise SDKException("Subclient", "102", "File version mode can only be 1 or 2")
                modes = {1: "keepOlderVersionsForNDays", 2: "keepVersions"}

                new_value[modes[value["Mode"]]] = value["DaysOrNumber"]

            # For Indexing V1 client
            else:
                new_value = {"keepAtLeastPreviousVersions": value["DaysOrNumber"]}

            self._set_subclient_properties("_fs_subclient_prop", new_value)
        else:
            raise SDKException("Subclient", "102", "Parameter need to be dictionary")
    ...
    def generate_signature_on_ibmi(self, generate_signature_value):
        ...
        """
        self._set_subclient_properties(
            "_fsSubClientProp['genSignatureOnIBMi']", generate_signature_value
        )
    ...
    def backup_using_multiple_drives(self, set_vtl_multiple_drives):
        ...
        if isinstance(set_vtl_multiple_drives, bool):
            update_properties["fsSubClientProp"]["backupUsingMultipleDrives"] = (
                set_vtl_multiple_drives
            )
        else:
            raise SDKException("Subclient", "101")
    ...
    def object_level_backup(self, object_level_value):
        ...
        """
        self._set_subclient_properties("_fsSubClientProp['backupAsObjects']", object_level_value)
    ...
    def use_vss(self):
        ...
        """
        return {
            "useVSS": self._fsSubClientProp["useVSS"],
    ...
    def use_vss(self, value):
        ...
        if isinstance(value["useVssForAllFilesOptions"], int) and value[
            "useVssForAllFilesOptions"
        ] in range(1, 4):
    ...
    def restore_out_of_place(
        ...
        if fs_options is not None and fs_options.get("is_vlr_restore", False):
            ...
            destination_options = request_json["taskInfo"]["subTasks"][0]["options"][
                "restoreOptions"
            ].get("destination", {})
    ...
    def ibmi_dr_config(self):
        ...
        """
        return {
            "backupMaxTime": self._fsSubClientProp.get("ibmiSubclientprop", {}).get(
                "backupMaxTime", 0
            ),
            "printSysInfo": self._fsSubClientProp.get("ibmiSubclientprop", {}).get(
                "printSysInfo", False
            ),
            "userProgram": self._fsSubClientProp.get("ibmiSubclientprop", {}).get(
                "userProgram", ""
            ),
            "saveSecData": self._fsSubClientProp.get("ibmiSubclientprop", {}).get(
                "saveSecData", False
            ),
            "saveConfObject": self._fsSubClientProp.get("ibmiSubclientprop", {}).get(
    ...
    def pre_post_commands(self):
        ...
        pre_post_commands = {
            "pre_scan_command": pre_scan_command,
    ...
    def backup_nodes(self, value):
        ...
        update_properties["fsSubClientProp"]["backupConfiguration"] = {
            "backupDataAccessNodes": access_nodes
        }
        self.update_properties(update_properties)
    ...
    def impersonate_user(self, value):
        ...
        if isinstance(value, dict):
            ...
            update_properties["impersonateUser"]["password"] = b64encode(
    ...
    def add_comparison(self, name, source_backup_time, compare_with_time):
        ...
        flag, response = self._commcell_object._cvpysdk_object.make_request(
            "POST", comparison_task, request_json
        )
        ...
        if flag:
            if response.json():
                if "jobIds" in response.json():
                    ...
                    o_str = f'Failed to start the comparison job.\nError: "{error_message}"'
                    raise SDKException("Subclient", "118", o_str)
                else:
