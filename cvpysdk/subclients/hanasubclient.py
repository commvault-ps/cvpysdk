...
class SAPHANASubclient(DatabaseSubclient):
    ...
    def _backup_request_json(self, backup_level, backup_prefix=None):
        """
        ...
        hana_options = {"hanaOptions": {"backupPrefix": str(backup_prefix)}}
    ...
    def content(self, value):
        ...
        """
        raise SDKException(
            "Subclient", "102", ("Updating SAP HANA subclient Content is not allowed. ")
        )
