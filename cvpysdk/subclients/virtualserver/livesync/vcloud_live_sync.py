...
"""File for configuring and monitoring live sync on the vCloud subclient.

vCloudLiveSync is the only class defined in this file.

vCloudLiveSync: Class for configuring and monitoring vCloud subclient live sync
...
class vCloudLiveSync(VsaLiveSync):
    """Class for configuring and monitoring vCloud live sync operations"""
    ...
    def configure_live_sync(
        ...
        Args:
            ...
            destination_client          (str)   -- vCloud Client Name where VM needs to be restored
        ...
        self._subclient_object._set_restore_inputs(
            ...
            vcloud_client=destination_client,
