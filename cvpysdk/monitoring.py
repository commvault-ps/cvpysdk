...
class MonitoringPolicies:
    ...
    def __init__(self, commcell_object):
        ...
        self._MONITORING_POLICIES_OPERATIONS = self._services["CREATE_DELETE_EDIT_OPERATIONS"]
    ...
    def has_monitoring_policy(self, monitoring_policy_name):
        ...
        return (
            ...
            and monitoring_policy_name.lower() in self.all_monitoring_policies
        )
    ...
    def _get_analytics_servers(self):
        ...
        Raises:
            SDKException:
                ...
                if response is not success
        """
        flag, response = self._cvpysdk_object.make_request("GET", self._ANALYTICS_SERVERS)
    ...
    def has_analytics_server(self, analytics_server_name):
        ...
        return (
            ...
            and analytics_server_name.lower() in self.all_analytics_servers
        )
    ...
    def _get_templates(self):
        ...
        flag, response = self._cvpysdk_object.make_request("POST", self._TEMPLATES, xml_request)
        ...
        if flag:
            if response.json() and "LMTemplates" in response.json():
                ...
                for dictionary in response.json()["LMTemplates"]:
                    ...
                    templates_dict[temp_name] = {"id": temp_id, "type": temp_type}
    ...
    def get(self, monitoring_policy_name):
        ...
        if not self.has_monitoring_policy(monitoring_policy_name):
            raise SDKException(
                "Monitoring", "102", f"No policy exists with name :{monitoring_policy_name}"
            )
        ...
        **kwargs,
        ...
        if template_name == "ondemand":
            ...
            if self.has_template(template_name):
                ...
                err_msg = f'Template "{template_name}" doesn\'t exist'
        ...
        if policy_type == 0:
            ...
            if self.has_analytics_server(analytics_server_name):
                ...
                err_msg = f'Analytics Server "{analytics_server_name}" doesn\'t exist'
                raise SDKException("Monitoring", "102", err_msg)
        ...
        if self._commcell_object.clients.has_client(client_name):
            ...
            err_msg = f'Client "{client_name}" doesn\'t exist'
            raise SDKException("Monitoring", "102", err_msg)
        ...
        request = {
            ...
            "policy": {
                ...
                "associations": [{"clientName": client_name, "clientId": client_id, "_type_": 3}],
                "monitoringTypes": [template_type],
                "LMTemplates": [{"templateName": template_name, "templateId": template_id}],
                "criteria": [
                    {"conditionsXML": kwargs.get("conditionsXML", ""), "templateId": template_id}
                ],
            ...
            if response.json():
                ...
                if error_code != 0:
                    ...
                    raise SDKException(
                        "Monitoring",
                        "102",
                        f'Failed to create MonitoringPolicy\nError: "{error_string}"',
                    )
                self.refresh()
            else:
                raise SDKException("Response", "102")
    ...
    def delete(self, monitoring_policy_name):
        ...
        if not isinstance(monitoring_policy_name, str):
            ...
            if self.has_monitoring_policy(monitoring_policy_name):
                ...
                if flag:
                    if response.json():
                        ...
                        if error_code != 0:
                            ...
                            raise SDKException(
                                "Monitoring",
                                f'102Failed to delete MonitoringPolicy\nError: "{error_string}"',
                            )
                ...
                err_msg = f'MonitoringPolicy "{monitoring_policy_name}" doesn\'t exist'
                raise SDKException("Monitoring", "102", err_msg)
...
class MonitoringPolicy:
    ...
    def __init__(self, commcell_object, monitoring_policy_name, monitoring_policy_id=None):
        ...
        self._RUN_MONITORING_POLICY = self._commcell_object._services["RUN_MONITORING_POLICY"] % (
            self._monitoring_policy_id
        )

    def __repr__(self):
        """String representation of the instance of this class"""
        representation_string = 'Monitoring Policy class instance for Monitoring Policy: "{0}"'
    ...
    def _get_monitoring_policy_id(self):
        ...
        return monitoring_policies.get(self.monitoring_policy_name).monitoring_policy_id
