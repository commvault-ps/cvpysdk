...
EXCEPTION_DICT = {
    ...
    "DisasterRecovery": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Client": {
    ...
    "Instance": {
        ...
        "107": "Unsupported auto discovery mode provided.Valid values are REGEX and GROUP",
    ...
    "Job": {
        ...
        "109": "Failed to fetch active jobs summary",
    },
    "Storage": {
        "101": "Data type of the input(s) is not valid",
        "102": "",
    ...
    "UserGroup": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Domain": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Alert": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Workflow": {
        "101": "Data type of the input(s) is not valid",
        "102": "",
    ...
    "EntityManager": {"101": "Data type of the input(s) is not valid", "102": ""},
    "GlobalFilter": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Plan": {
        "101": "Data type of the input(s) is not valid",
        "102": "",
    ...
    "Metrics": {"101": "Invalid input(s) specified"},
    "InternetOptions": {"101": "Invalid input(s) specified"},
    "Virtual Machine": {"101": "Data type of the input(s) is not valid", "102": ""},
    "User": {
    ...
    "Role": {"101": "Data type of input(s) is not valid", "102": ""},
    "Security": {"101": "Data type of input(s) is not valid", "102": ""},
    "Credential": {"101": "Data type of input(s) is not valid", "102": ""},
    "DownloadCenter": {
        ...
        "111": (
            "Multiple download types available for this platform. Please specify the download type"
        ),
    ...
    "Organization": {
        ...
        "111": (
            "Plan is not associated with the organization. "
    ...
    "Monitoring": {"101": "Data type of the input(s) is not valid", "102": ""},
    "ReplicationPairs": {
    ...
    "ReplicationGroup": {"101": "Data type of the input(s) is not valid", "102": ""},
    "FailoverGroup": {
        "101": "Data type of the input(s) is not valid",
        "102": "",
        "103": "Failover group does not exist",
    },
    "ConfigurationPolicies": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Snap": {
    ...
    "NetworkTopology": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Certificates": {"101": "Data type of the input(s) is not valid", "102": ""},
    "Download": {
    ...
    "LiveSync": {"101": "Data type of the input(s) is not valid", "102": ""},
    "BackupNetworkPairs": {
        "101": "",
    },
    "Uninstall": {"101": "Data type of the input(s) is not valid", "102": ""},
    "IndexServers": {
        "101": "Data type of the input(s) is not valid",
    ...
    "Metallic": {"101": "Data type of the input(s) is not valid", "102": ""},
    "KeyManagementServer": {
        "101": "Data type of the input(s) is not valid",
    ...
    "Region": {"101": "Entity type not found.", "102": ""},
    "RecoveryGroup": {
        "101": "Data type of the input(s) is not valid",
    ...
    "AdditionalSettings": {"101": "Data type of the input(s) is not valid", "102": ""},
    "ServiceCommcells": {
        "101": "",
